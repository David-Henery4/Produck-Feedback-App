  ...
  return (
    <div>
      <div>
        ...
        <p className="text-gray font-medium">{inputDescription}</p>
      </div>
      ...
      >
        <input
          ...
          id={inputName}
          name={inputName}
          className="w-full h-full p-4 rounded-md font-medium capitalize hover:cursor-pointer bg-offWhite outline-blue"
          readOnly
          value={value}
        />
